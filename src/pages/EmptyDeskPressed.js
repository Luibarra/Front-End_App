import styles from "./EmptyDeskPressed.module.css";
const EmptyDeskPressed = () => {
  return (
    <div className={styles.emptydeskpressed}>
      <div className={styles.setscanstep}>
        ...
        <div className={styles.continousscanbutton}>
          <img
            ...
            alt=""
            src="/scanstateoff-14@2x.png"
          />
          <img
            className={styles.scanstateon1Icon}
            alt=""
            src="/scanstateon-14@2x.png"
          />
        </div>
...
export default EmptyDeskPressed;
