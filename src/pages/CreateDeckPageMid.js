...
import styles from "./CreateDeckPageMid.module.css";
const CreateDeckPageMid = () => {
  ...
  return (
    <div className={styles.createdeckpagemid}>
      ...
      <div className={styles.deckboxicon2}>
        <img
          className={styles.settings1Icon}
          alt=""
...
export default CreateDeckPageMid;
