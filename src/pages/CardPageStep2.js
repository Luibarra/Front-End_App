...
import styles from "./CardPageStep2.module.css";
const CardPageStep2 = () => {
  ...
  return (
    <div className={styles.cardpagestepsubmit}>
      ...
      <div className={styles.homebarRegionv2}>
        <div className={styles.homebarRegion}>
          ...
          <div className={styles.decksButtonv2}>
            <img className={styles.decks1Icon} alt="" src="/decks-12@2x.png" />
            <img
      ...
      <div className={styles.addButton}>
        <img className={styles.add1Icon} alt="" src="/add1@3x.png" />
